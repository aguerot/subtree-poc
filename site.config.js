module.exports = {
  ...
  site: {
    title: 'Domaine Eric Bordelet',
    google: {
      verification: 'cBoUT0UWNWyv64VguKrQ-jqQvTYf2QgMNVNivoE25Wc',
      analytics: 'UA-59489444-1'
    },
    keywords: 'eric bordelet, poiré, poire, sidre, cidre, sydre, argelette, granit, corme, cormé, cormier',
    products: [
      {
